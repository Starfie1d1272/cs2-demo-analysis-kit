...
| `@cs2dak/maps` | 7 图 radar 标定、world-to-radar、进攻动线模型（`MapRoute` / type+confidence）、callout 中文映射、zone 类型与几何、Mirage 模板、动线可视化脚本 | 正式 zone 数据集、anubis/inferno/overpass 动线、空间查询能力 | UI 路径与产品文案；战术评分结论 |
