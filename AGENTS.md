...
| `apps/dak-studio` | DAK Studio：本地 Demo 管理、战术分析与个人打法复盘工作台（独立设计语言；导入即提取 facts 行持久化，视图读投影；IndexedDB 开发 / SQLite 桌面双后端）。 |
...
> **已迁移**：cs2-demo-format 3.0.3（2026-06）。TS 管线全部使用 v3 合同，
